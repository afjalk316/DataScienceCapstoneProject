...
if st.button("Predict"):
    ...
    input_data = pd.DataFrame({
        ...
        "seller_type_Trustmark_Dealer": [1 if seller_type_trustmark_dealer else 0],
        ...
        "owner_Fourth_and_Above": [1 if owner_fourth_and_above else 0],
        "owner_Test_Drive_Car": [1 if owner_test_drive_car else 0],
    })
