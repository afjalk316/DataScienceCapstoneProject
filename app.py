...
fuel_electric = st.checkbox("Electric")
fuel_lpg = st.checkbox("LPG")
...
seller_type_trustmark_dealer = st.checkbox("Trustmark Dealer")
...
if st.button("Predict"):
    ...
    input_data = pd.DataFrame({
        ...
        "fuel_Electric": [1 if fuel_electric else 0],
        "fuel_LPG": [1 if fuel_lpg else 0],
        ...
        "owner_Fourth & Above Owner": [1 if owner_fourth_and_above else 0],
        "owner_Second Owner": [1 if owner_second else 0],
        "owner_Test Drive Car": [1 if owner_test_drive_car else 0],
        "owner_Third Owner": [1 if owner_third else 0],
    })
